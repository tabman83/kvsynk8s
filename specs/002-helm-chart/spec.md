...
- **FR-008**: The chart's values MUST expose image repository, tag, and pull policy; the repository MUST default to `ghcr.io/tabman83/kvsynk8s` and the tag MUST default to the chart's app version.
